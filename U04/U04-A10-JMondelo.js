...
//AQUI ESTA LA TABLA ECHA CON LOS DOS COCHES
var tablaHTML = '<table border="2"><tr><th>Marca</th><th>Modelo</th><th>Color</th><th>Año</th><th>Cilindrada</th></tr>';
tablaHTML += '<tr><td>' + vehiculo1.marca_ + '</td><td>' + vehiculo1.modelo_ + '</td><td>' + vehiculo1.color_ + '</td><td>' + vehiculo1.año_ + '</td><td>' + vehiculo1.cilindrada + '</td></tr>';
tablaHTML += '<tr><td>' + vehiculo2.marca_ + '</td><td>' + vehiculo2.modelo_ + '</td><td>' + vehiculo2.color_ + '</td><td>' + vehiculo2.año_ + '</td><td>' + vehiculo2.cilindrada + '</td></tr>';
tablaHTML += '</table>';
document.getElementById('div8').innerHTML = '<br>'+tablaHTML;
